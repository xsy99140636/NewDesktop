...
namespace NewDesktop.Views.Common;
...
public partial class ColorPickerUserControl
{
    ...
    partial void OnAChanged(byte value) => SelectedColor = Color.FromArgb(A, R, G, B);
